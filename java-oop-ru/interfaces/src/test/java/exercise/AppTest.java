...
class AppTest {
    ...
    public class ReversedSequenceTest {
        ...
        public void testLength() {
            ...
            CharSequence sequence = new ReversedSequence("hello");
        ...
        public void testSubSequence() {
            ...
            CharSequence sequence = new ReversedSequence("hello world");

            assertEquals("dlro", sequence.subSequence(2, 6));
        ...
        public void testToString() {
            ...
            assertEquals("dlrow olleh", sequence.toString());
